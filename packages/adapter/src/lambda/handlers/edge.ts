...
const edgeHandler: CloudFrontRequestHandler = async (
	...
	adapterLogger.info(`Handling origin request`)
...
const handler = withLogger(adapterLogger, loggerOptions, edgeHandler)
