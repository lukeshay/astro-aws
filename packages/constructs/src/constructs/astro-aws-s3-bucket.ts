import { BlockPublicAccess, Bucket, BucketEncryption, type BucketProps } from "aws-cdk-lib/aws-s3";
...
class AstroAWSS3Bucket extends AstroAWSBaseConstruct<AstroAWSS3BucketProps, AstroAWSS3BucketCdk> {
	...
	public constructor(scope: Construct, id: string, props: AstroAWSS3BucketProps) {
		...
		this.#s3Bucket.addToResourcePolicy(
			new PolicyStatement({
				...
				principals: [
					new CanonicalUserPrincipal(this.#originAccessIdentity.cloudFrontOriginAccessIdentityS3CanonicalUserId)
						.grantPrincipal,
				],
