...
import { AstroAWSS3Bucket, type AstroAWSS3BucketCdk, type AstroAWSS3BucketCdkProps } from "./astro-aws-s3-bucket.js";
import { type AstroAWSOriginCdkProps, AstroAWSOrigin, type AstroAWSOriginCdk } from "./astro-aws-origin.js";
import type {
 ...
 */
export class AstroAWS extends AstroAWSBaseConstruct<AstroAWSProps, AstroAWSCdk> {
	...
	public constructor(scope: Construct, id: string, props: AstroAWSProps) {
		...
		this.#astroAWSCloudfrontDistribution = new AstroAWSCloudfrontDistribution(this, "AstroAWSCloudfrontDistribution", {
			cdk: this.props.cdk,
			lambdaFunction: this.#lambdaFunction,
		...
		this.#astroAWSS3BucketDeployment = new AstroAWSS3BucketDeployment(this, "AstroAWSS3BucketDeployment", {
			bucket: this.#astroAWSS3Bucket.cdk.s3Bucket,
			cdk: this.props.cdk,
			distDir: this.distDir,
			distribution: this.#astroAWSCloudfrontDistribution.cdk.cloudfrontDistribution,
