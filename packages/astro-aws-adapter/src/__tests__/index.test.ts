	...
	describe("astroAWSFunctions", () => {
		...
		describe("hooks", () => {
			let config: AstroConfig,
				routes: RouteData[],
				astroConfigSetup: NonNullable<AstroIntegration["hooks"]["astro:config:setup"]>,
				astroConfigDone: NonNullable<AstroIntegration["hooks"]["astro:config:done"]>,
				astroBuildDone: NonNullable<AstroIntegration["hooks"]["astro:build:done"]>,
